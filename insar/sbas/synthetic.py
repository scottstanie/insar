...
class IgramMaker:
    ...
    def mask_igrams(self, igram_fname_list, igram_date_list, geo_date_list):
        mask.save_int_masks(
            igram_fname_list, igram_date_list, geo_date_list, geo_path="."
        )
    ...
    def run_inversion(self):
        ...
        varr = timeseries.invert_sbas(
            columns_masked, B, geo_mask_columns, constant_vel=self.constant_vel
        )
