...
defo_img2 = latlon.LatlonImage(
    data=np.mean(defo2[-3:], axis=0),
    dem_rsc_file="/data3/scott/pecos/path85stitch/igrams/dem.rsc",
)
...
fig.savefig(
    "defo_img_large_figure_discrete_seismic.png",
    bbox_inches="tight",
    transparent=True,
    dpi=300,
)
...
fig.savefig(
    "defo_img_figure_seismic.png", bbox_inches="tight", transparent=True, dpi=300
)
